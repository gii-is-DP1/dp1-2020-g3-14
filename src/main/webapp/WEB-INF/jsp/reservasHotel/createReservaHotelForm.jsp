...
<petclinic:layout pageName="reservasHotel">
    <h2>
        <c:if test="${reservasHotel['new']}">New </c:if> ReservaHotel
    </h2>
    <form:form modelAttribute="reservaHotel" class="form-horizontal" id="add-owner-form">
