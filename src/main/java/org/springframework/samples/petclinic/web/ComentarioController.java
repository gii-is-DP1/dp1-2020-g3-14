...
public class ComentarioController {
	...
	@Autowired
	public ComentarioController(ComentarioService comentarioService,HotelService hotelService) {
	...
	public String processCreationForm(@PathVariable("hotelId") int hotelId, @Valid Comentario comentario, BindingResult result) {		
		if (result.hasErrors()) {
			return VIEWS_COMENTARIO_FORM;
		}
		else {
