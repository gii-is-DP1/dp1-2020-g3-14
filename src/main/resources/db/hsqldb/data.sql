...
INSERT INTO actividades(id,direccion,nombre,provincia,opinion,precio,valoracion,agenact_id) VALUES (1, 'Playa de Cadiz','Surf Cadiz','Sevilla', 'El mejor Surf en Cadiz', '20', 3,1);
INSERT INTO actividades(id,direccion,nombre,provincia,opinion,precio,valoracion,agenact_id) VALUES (2, 'Sierra de Grazalema','Senderismo','Sevilla', 'Increible paisaje', '1' , 4,1);
INSERT INTO actividades(id,direccion,nombre,provincia,opinion,precio,valoracion,agenact_id) VALUES (3, 'Ayuntamiento de Sevilla', 'Visita guiada','Malaga', 'Sevilla es preciosa', '5', 4,2);
