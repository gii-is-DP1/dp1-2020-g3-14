...
INSERT INTO actividades(id,direccion,nombre,descripcion,precio,valoracion,fecha,agenact_id,provincia) VALUES (1, 'Playa de Cadiz','Surf Cadiz', 'El mejor Surf en Cadiz', '20', 0,'2021-12-17',1,'Cadiz');
INSERT INTO actividades(id,direccion,nombre,descripcion,precio,valoracion,fecha,agenact_id,provincia) VALUES (2, 'Sierra de Grazalema','Senderismo', 'Increible paisaje', '1' , 0,'2021-12-17',1,'Cadiz');
INSERT INTO actividades(id,direccion,nombre,descripcion,precio,valoracion,fecha,agenact_id,provincia) VALUES (3, 'Ayuntamiento de Sevilla', 'Visita guiada', 'Sevilla es preciosa', '5', 0,'2021-12-17',2,'Sevilla');
...
INSERT INTO vuelos(id,billetes,destino,fecha_ida,fecha_vuelta,origen,precio,compvuelo_id) VALUES (1, 2, 'Malaga', '2021-12-17', '2021-12-24', 'Sevilla', 70,1);
INSERT INTO vuelos(id,billetes,destino,fecha_ida,fecha_vuelta,origen,precio,compvuelo_id) VALUES (2, 1, 'Almeria', '2021-12-16', '2021-12-25', 'Malaga', 40,2);
INSERT INTO vuelos(id,billetes,destino,fecha_ida,fecha_vuelta,origen,precio,compvuelo_id) VALUES (3, 3, 'Cadiz', '2021-12-19', '2021-12-26','Cordoba', 120,2);
