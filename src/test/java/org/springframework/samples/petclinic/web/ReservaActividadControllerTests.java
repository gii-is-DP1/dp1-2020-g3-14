...
public class ReservaActividadControllerTests {
	...
	void setup() {
		...
		reservaActividad.setFechaReserva(LocalDate.of(2021, Month.APRIL, 10));
		reservaActividad.setEntrada(LocalDate.of(2021, Month.APRIL, 13));
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc.perform(post("/actividades/{actividadId}/reservaActividad/new",1).param("fechaReserva", "2021/10/20")
							.with(csrf())
							.param("entrada", "2021/10/24")
	...
	void testShowReservaActividad() throws Exception {
		mockMvc.perform(get("/actividades/{actividadId}/reservaActividad/{reservaActividadID}/",1, TEST_RESERVAACTIVIDAD_ID)).andExpect(status().isOk())
				.andExpect(model().attribute("reservaActividad", hasProperty("fechaReserva", is(LocalDate.of(2021, Month.APRIL, 10)))))
				.andExpect(model().attribute("reservaActividad", hasProperty("entrada", is(LocalDate.of(2021, Month.APRIL, 13)))))
